...
class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests(arc -> {
            ...
            arc
//                    .mvcMatchers("/api/greet/me/u2").hasAuthority("SCOPE_urn:zitadel:iam:org:project:role:p1-u2-role")
//                    .mvcMatchers("/api/greet/me/u3").hasAuthority("ROLE_p1-u3-role")
//                    .mvcMatchers("/api/greet/me/u3").hasAuthority("SCOPE_urn:zitadel:iam:org:project:role:p1-u3-role")
